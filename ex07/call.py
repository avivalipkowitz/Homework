...
def update_called(customers, date):
	date = argv[1]
	customers['customer']['called'] = date
	print customer.get('first', ''), customer.get('last', ''), "called on", customer.get('date', '')
	return date
